...
typedef enum {
	ERIS_LOW_7UP_MAP_32X32 = 0,
	ERIS_LOW_7UP_MAP_64X32 = 1,
	ERIS_LOW_7UP_MAP_128X32 = 2,
	ERIS_LOW_7UP_MAP_32X64 = 4,
	ERIS_LOW_7UP_MAP_64X64 = 5,
	ERIS_LOW_7UP_MAP_128X64 = 7
...
void eris_low_7up_set_control(int chip, int increment, int bg_show,
				int spr_show);
void eris_low_7up_set_interrupts(int chip, int irq_on, int raster_irq,
...
void eris_low_7up_set_access_width(int chip, int color_mode,
